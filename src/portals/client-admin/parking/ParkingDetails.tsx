  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed inset-y-0 right-0 z-50 flex w-full max-w-2xl flex-col border-l border-slate-200 bg-white shadow-lg outline-none data-[state=open]:animate-in data-[state=open]:slide-in-from-right data-[state=closed]:animate-out data-[state=closed]:slide-out-to-right dark:border-slate-800 dark:bg-slate-950">
          ...
          <div className="flex-1 overflow-y-auto p-5">
            ...
            <section className="mt-5 rounded-lg border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-950">
              <h3 className="mb-4 font-bold text-slate-900 dark:text-white">Map Preview</h3>
              <div className="relative h-56 overflow-hidden rounded-lg bg-slate-100 dark:bg-slate-900">
