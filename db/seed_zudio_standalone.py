...
DB_URL = "postgresql://postgres:Girish%40123@localhost:5432/parkease_db"

async def main():
    print("🌱 Connecting directly to PostgreSQL via asyncpg...")
    ...
    try:
        ...
        print("   Facility Name: Zudio Parking")
        print("   Floor ID: fl_zudio_b1 (Basement B1)")
        print("   Slots created: 15 slots (Z-01 to Z-15)")
    finally:
        await conn.close()
