...
const ParkingTable = ({
  ...
  if (error) {
    return (
      <div className="rounded-lg border border-rose-200 bg-rose-50 p-8 text-center dark:border-rose-500/20 dark:bg-rose-500/10">
      ...
      <AnimatePresence>
        {selectedIds.length > 0 && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -8 }}
            className="flex flex-col gap-3 rounded-lg border border-brand-200 bg-brand-50 p-3 dark:border-brand-500/20 dark:bg-brand-500/10 sm:flex-row sm:items-center sm:justify-between"
          >
