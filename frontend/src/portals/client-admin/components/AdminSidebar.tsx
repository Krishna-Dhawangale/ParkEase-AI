...
const navigation: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Digital Twin', icon: Boxes, path: '/admin/digital-twin' },
      { label: 'Bookings', icon: CalendarCheck, path: '/admin/bookings' },
      { label: 'Customers', icon: Users2, path: '/admin/customers' },
    ],
  },
  {
    label: 'Intelligence',
    items: [
      ...
      { label: 'AI Operations', icon: Brain, path: '/admin/ai' },
    ],
  },
  {
    label: 'Business',
  ...
  },
  {
    label: 'Systems',
    items: [
      { label: 'IoT & Devices', icon: ServerCog, path: '/admin/devices' },
